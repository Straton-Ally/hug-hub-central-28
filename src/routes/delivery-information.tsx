          ...
          >
            {[
              [
                "01",
                "Basket",
                "Products and quantities determine which delivery services can be offered.",
              ],
              [
                "02",
                "Checkout",
                "The delivery address and Shopify shipping rules calculate the available charge.",
              ],
              [
                "03",
                "Order updates",
                "Dispatch and tracking are emailed and shown on the secure order-status page.",
              ],
          ...
          <section className="mt-10 border border-rule bg-surface p-5 md:flex md:items-center md:justify-between md:gap-8 md:p-7">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-ink-muted">
                Open a return request and select the affected item, quantity, and reason. The
                request is saved in the CMS and immediately receives an email reference.
              </p>
            </div>
            <Link
              to="/returns"
